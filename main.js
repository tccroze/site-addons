...
import './addons/hero-reveal.js?v=2.39.0';

import './addons/gallery-hover.js?v=2.39.0';
import './addons/gallery-filter.js?v=2.39.0';
import './addons/cursor.js?v=2.39.0';
import './addons/page-transition.js?v=2.39.0';
import './addons/signature.js?v=2.39.0';

// Homepage only
import './addons/masked-intro.js?v=2.39.0';
import './addons/dune-reveal.js?v=2.39.0';
import './addons/scroll-reveal.js?v=2.39.0';
import './addons/testimonial-rotator.js?v=2.39.0';
import './addons/parallax.js?v=2.39.0';
